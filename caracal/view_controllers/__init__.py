...
from caracal.view_controllers.entry_form import entry_form
...
class event_loop(npyscreen.NPSAppManaged):
    ...
    def onStart(self):
        ...
        self.addForm("EXECUTIONVIEW", execution_form,
                     name="Pipeline execution")
        self.addForm("ADVOPTIONEDITOR", misc_opts_form,
                     name="Advanced options")
        self.addForm("OPTIONEDITOR", option_editor,
                     name="Pipeline configuration editor")
