    ...
    for tt, target in enumerate(all_targets):
        ...
        if pipeline.enable_task(config, "imcontsub"):
            imcontsub_opts = {
                ...
                "ncpus": sdm.dismissable(config["imcontsub"]["ncpus"]),
            ...
            if not config["imcontsub"]["input_cube"]:
                ...
                for uu in range(len(imsub_image_cube_list)):
                    ...
                    if config["imcontsub"]["mask_image"] == "sofia":
                        ...
                        print(config["imcontsub"]["mask_image"])
                        if not config["imcontsub"]["mask_image"] and os.path.exists("{0:s}/{1:s}".format(pipeline.masking, config["imcontsub"]["mask_image"])):
