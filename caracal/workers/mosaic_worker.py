            ...
            if specified_mosaictype == 'spectral':
                ...
                if pb_type == 'gaussian':
                    ...
                    caracal.log.info('If these are not the values that you were expecting to be used for primary-beam creation, then '
                            'please re-run the mosaic worker with ref_frequency and dish_diameter set in the config file.')
                    ...
                    caracal.log.info('If this is not the value that you were expecting to be used for primary-beam creation, then '
                            'please re-run the mosaic worker with ref_frequency set in the config file.')
