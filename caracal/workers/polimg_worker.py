...
def worker(pipeline, recipe, config):
    ...
    def rename_single_stokes(img_dir, field, stokes):
        ...
        llist = list(
            set(glob.glob("{0:s}{1:s}".format(posname, "*dirty.fits")))
        ...
        llist = list(
            set(glob.glob("{0:s}{1:s}".format(posname, "*image.fits")))
        ...
        llist = list(
            set(glob.glob("{0:s}{1:s}".format(posname, "*model.fits")))
        ...
        llist = list(
            set(glob.glob("{0:s}{1:s}".format(posname, "*residual.fits")))
