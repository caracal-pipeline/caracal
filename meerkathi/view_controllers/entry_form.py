...
class entry_form(npyscreen.FormBaseNew):
    ...
    def create(self):
        ...
        self.add(npyscreen.TitleText, editable=False, name="\t\t\t",
                 value="╚═╝     ╚═╝╚══════╝╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝   ╚═╝   ╚═╝  ╚═╝╚═╝")
        self.add(npyscreen.TitleText, editable=False, name="\t\t\t",
                 value="Module installed at: {0:s} (version {1:s})".format(meerkathi.pckgdir, str(meerkathi.__version__)))
        self.add(npyscreen.TitleText, editable=False, name="\t\t\t",
                 value="A logfile will be dumped here: {0:s}".format(meerkathi.MEERKATHI_LOG))
        self.add(npyscreen.TitleText, editable=False, name="\t\t\t",
