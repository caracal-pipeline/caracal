    ...
    for image_name in specified_images: 
        ...
        if os.path.exists(pathname + '/' + pb_name):
		    ...
		    input=pipeline.input,
                ...
                ### Trying to work out obs_freq and dish_diameter are 'NoneType'
                meerkathi.log.info('Observing frequency = {0:f}, dish diameter = {1:f}'.format( config['ref_frequency'], config['dish_diameter'] )) 
